import{j as n}from"./jsx-runtime--26OcTxz.js";import{b as o}from"./index-UymYeMGS.js";import"./output-DOol9aOf.js";import"./index-BLgStI3F.js";import"./_commonjsHelpers-BosuxZz1.js";import"./extends-CCbyfPlC.js";import"./index-B99Sp-t6.js";const p={title:"Components/Toggle",component:o.Root,args:{size:"md"},argTypes:{size:{options:["sm","md"],control:{type:"inline-radio"}}},parameters:{docs:{description:{component:`This story displays the \`Toggle\` component, which is a React element built using Pattern Composition. Types generated for each component are exported as \`Toggle{ComponentName}Props\`.
...
\`[data-disabled]\` - The control will be disabled`}}}},e={args:{size:"md"},render:t=>n.jsx(o.Root,{size:t.size,children:n.jsx(o.Control,{size:t.size})})};var s,r,a;e.parameters={...e.parameters,docs:{...(s=e.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    size: 'md'
  },
...
}`,...(a=(r=e.parameters)==null?void 0:r.docs)==null?void 0:a.source}}};const T=["Default"];export{e as Default,T as __namedExportsOrder,p as default};
